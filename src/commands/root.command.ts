...
Example Usage
  ...
  $ ${example(
    ...
    Generate a receipt merkle proof for the transaction with hash 0x064eaad7fb35c25410aec7f55603d9bb95436891cbda68a4be9a6fc3b19ca0a5.
  ...
  $ ${example(
    ...
    Get the receipt trie root of the block containing the transaction with hash 0x064eaad7fb35c25410aec7f55603d9bb95436891cbda68a4be9a6fc3b19ca0a5.
